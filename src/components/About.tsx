  ...
  return (
    <section id="about" className="py-24 px-8 surface-alt relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-foreground font-heebo mb-2">אודותיי</h2>
        ...
        >
          <p className="font-heebo font-light text-sm md:text-base text-foreground/75 leading-relaxed mb-6 text-right">
          ...
          <p className="font-heebo font-light text-sm md:text-base text-foreground/75 leading-relaxed text-right">
